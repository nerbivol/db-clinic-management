...
import edu.kpi.iasa.clinic.api.dto.VisitDto;
import edu.kpi.iasa.clinic.repository.model.Visit;
import edu.kpi.iasa.clinic.service.impl.VisitServiceImpl;
...
public class VisitController {
    ...
    @PostMapping
    public ResponseEntity<Visit> create(@Valid @RequestBody VisitDto visit){
